export const checkSignInData = (email, password) => {
  ...
  if (!isPasswordValid)
    return "Password must contain special character, number, small letter and capital letter.";
...
export const checkSignUpData = (fullName, email, password) => {
  ...
  if (!isFullNameValid)
    return "Invalid full name (capitalize first letter, no alphanumeric characters)";
